...
<title>G-type詳細 | 間取り | グランファーレ真駒内グランフォレスト | 日本グランデ株式会社</title>
...
<main class="detail-main">
        ...
        <div class="page">
            <div class="detail">
                <div class="main">
                    ...
                    <ul class="data">
                        <li>専有面積／44.17㎡（13.36坪）《TR面積1.45㎡（0.43坪）を含む》</li>
                        <li>バルコニー面積／8.95㎡（2.70坪）</li>
                        <li>アルコーブ面積／0.83㎡（0.25坪）</li>
                        <li>SC：玄関クローゼット　KP：キッチンパントリー　AL：アルコーブ　TR：トランクルーム </li>
                    </ul>
                    <p class="cap">リビングダイニングキッチン、全洋室がワイドバルコニーに面した1LDKプランです。玄関にはトール型の玄関収納と玄関クローゼットをご用意。さらにキッチンにパントリーを完備し、すっきりとした空間を演出します。洋室1の引き戸を解放するとリビングダイニングキッチンと一体となった約17.4帖の広々とした空間を演出することも可能です。</p>
                    <p class="floorimg">
                ...
                <div id="menuplan">
                    ...
                    <div class="menu">
                        <dl>
                            ...
                            <dd>リビングダイニングと洋室1の間に間仕切り壁を設けてプライバシーを確保しました。</dd>
                        </dl>
                        <p class="floorimg">
                            <img src="../assets/svg/a-type/g-type_menu1.svg" width="630" height="615" alt="menu1">
                        </p>
                    </div>
                    <div class="menu">
                        <dl>
                            <dt class="fgara">menu<span>2</span></dt>
                            <dd>リビングダイニングに洋室1を取り込んだ1Rプランです。17.5帖大のリビングダイニングを実現しました。 </dd>
                        </dl>
                        <p class="floorimg">
                            <img src="../assets/svg/a-type/g-type_menu2.svg" width="630" height="615" alt="menu2">
                        </p>
                    </div>
                    <div class="menu">
                        <dl>
                    ...
                    <div class="menu">
                        <dl>
                            ...
                            <dd>リビングダイニングに洋室1を取り込んだ1Rプランです。キッチンパントリーと食器棚を一体化し、使い勝手の良さに配慮しました。</dd>
                        </dl>
                        <p class="floorimg">
                            <img src="../assets/svg/a-type/g-type_menu4.svg" width="630" height="615" alt="menu4">
                        </p>
                    </div>
                </div>
            </div>
    ...
    ?>
    <a href="<?php print URL; ?>/floor-plan/index.php?active-tab=tab-7#g-type" class="detail-close" id="modal-close">閉じる</a>
    </div>
