        ...
        <div class="page">
            <div class="detail">
                <div class="main">
                    ...
                    <p class="floorimg">
                        <img src="../assets/svg/a-type/h2-type.svg" width="700" height="718" alt="Htype">
                    </p>
                </div>
                ...
                <div id="menuplan">
                    ...
                    <div class="menu">
                        ...
                        <p class="floorimg">
                            <img src="../assets/svg/a-type/h-type_menu2.svg" width="630" height="615" alt="menu2">
                        </p>
                    </div>
                    <div class="menu">
                        <dl>
                            <dt class="fgara">menu<span>3</span></dt>
                            <dd>洋室1と洋室2を1部屋にした3LDKプランです。また、リビングダイニングと洋室4の間に間仕切り壁を設けてプライバシーを確保しました。</dd>
                        </dl>
                        <p class="floorimg">
                            <img src="../assets/svg/a-type/h-type_menu3.svg" width="630" height="615" alt="menu3">
                        </p>
                    </div>
                    <div class="menu">
                        <dl>
                            <dt class="fgara">menu<span>4</span></dt>
                            <dd>洋室2と洋室3を1部屋にした3LDKプランです。ホールクローゼットを奥行きのあるホール収納に変更した他、リビングダイニングと洋室4の間に間仕切り壁を設けてプライバシーを確保しました。</dd>
                        </dl>
                        <p class="floorimg">
                            <img src="../assets/svg/a-type/h-type_menu4.svg" width="630" height="615" alt="menu4">
                        </p>
                    </div>
                </div>
            </div>
