...
<title>F1-type詳細 | 間取り | グランファーレ真駒内グランフォレスト | 日本グランデ株式会社</title>
...
<main class="detail-main">
    ...
    ?>
    <a href="<?php print URL; ?>/floor-plan/index.php?active-tab=tab-6#f1-type" class="detail-close" id="modal-close">閉じる</a>
    </div>
