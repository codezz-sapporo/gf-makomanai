...
<title>M-type詳細 | 間取り | グランファーレ真駒内グランフォレスト | 日本グランデ株式会社</title>
...
<main class="detail-main">
            ...
            <div class="detail">
                <div class="main">
                    <div class="head fgara">
                        ...
                        <p class="size"><span>83.91</span>m<sup>2</sup></p>
                        <p class="floor"><span>4LDK</span>+OP+SIC+W+KP+R+AL+TR</p>
                    </div>
                    <ul class="data">
                        <li>専有面積／83.91㎡（25.38坪）《TR面積1.30㎡（0.39坪）を含む》</li>
                        <li>バルコニー面積／12.46㎡（3.76坪）</li>
                        <li>ルーフバルコニー面積／30.97㎡（9.36坪）</li>
                        <li>アルコーブ面積／2.56㎡（0.77坪）</li>
                        <li>OP：オープンペントハウス　SIC：シューズインクローゼット　W：ウォークインクローゼット　KP：キッチンパントリー　R：ルーフバルコニー　AL：アルコーブ　TR：トランクルーム</li>
                    </ul>
                    <p class="cap">リビングダイニングキッチン、全洋室がバルコニーに面したルーフバルコニー付き4LDKプランです。玄関にはコートや傘の他玄関に必要な物を出し入れできる玄関クロークとトール型の玄関収納をご用意。さらに洋室3にウォークインクローゼット、キッチンにパントリーを完備し収納力に配慮しました。洋室4の引き戸を解放するとリビングダイニングキッチンと一体となった約21.2帖の広々としたオープンペントハウスを演出することも可能です。</p>
                    <p class="floorimg">
                        <img src="../assets/svg/a-type/m-type.svg" width="700" height="718" alt="Mtype">
                    </p>
                </div>
    ...
    ?>
    <a href="<?php print URL; ?>/floor-plan/index.php?active-tab=tab-13#m-type" class="detail-close" id="modal-close">閉じる</a>
    </div>
