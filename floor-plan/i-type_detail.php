...
<title>I-type詳細 | 間取り | グランファーレ真駒内グランフォレスト | 日本グランデ株式会社</title>
...
<main class="detail-main">
            ...
            <div class="detail">
                <div class="main">
                    <div class="head fgara">
                        ...
                        <p class="size"><span>70.70</span>m<sup>2</sup></p>
                        <p class="floor"><span>3LDK</span>+HC+HS+AL+TR</p>
                    </div>
                    <ul class="data">
                        <li>専有面積／70.70㎡（21.38坪）《TR面積1.21㎡（0.36坪）を含む》</li>
                ...
                <div id="menuplan">
                    ...
                    <div class="menu">
                        ...
                        <p class="floorimg">
                            <img src="../assets/svg/a-type/i-type_menu1.svg" width="630" height="615" alt="menu1">
                        </p>
                    </div>
                    <div class="menu">
                        <dl>
                            <dt class="fgara">menu<span>2</span></dt>
                            <dd>リビングダイニングに洋室3を取り込んだ2LDKプランです。17.9帖大のリビングダイニングを実現しました。</dd>
                        </dl>
                        <p class="floorimg">
                            <img src="../assets/svg/a-type/i-type_menu2.svg" width="630" height="615" alt="menu2">
                        </p>
                    </div>
                    <div class="menu">
                        <dl>
                            <dt class="fgara">menu<span>3</span></dt>
                            <dd>洋室1と洋室2を1部屋にした2LDKプランです。2つのクローゼットを1つの大きなウォークインに変更した他、リビングダイニングと洋室3の間に間仕切り壁を設けてプライバシーを確保しました。</dd>
                        </dl>
                        <p class="floorimg">
                            <img src="../assets/svg/a-type/i-type_menu3.svg" width="630" height="615" alt="menu3">
                        </p>
                    </div>
                    <div class="menu">
                        <dl>
    ...
    ?>
    <a href="<?php print URL; ?>/floor-plan/index.php?active-tab=tab-9#i-type" class="detail-close" id="modal-close">閉じる</a>
    </div>
