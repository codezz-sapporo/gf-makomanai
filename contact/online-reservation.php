...
?>
	...
	<title>オンライン商談予約 | グランファーレ真駒内グランフォレスト | 日本グランデ株式会社</title>
...
?>
	...
	<main class="main">
		<div class="mainvisual mainvisual_only-text">
			<h1 class="mainvisual-title mainvisual-title_online"><span class="title-text">オンライン商談予約</span></h1>
		</div>
			...
			<div class="contents">
				...
				<div class="contact-page tab_main js-tab-cts is-active">
					<div class="contents tab-section">
						<div class="in">
							<div class="top fgo">
								■ご商談希望日時をご選択の上、《ご商談希望日時前日》までに、下記フォームよりご予約ください。<br>
							...
							<div class="inquiry mt50 fgo" id="inquiry">
								<?php if($error || empty($_POST)){ ?>
									<form action="#inquiry" method="post" name="form1">
										<div class="table">
											<div class="rows">
												<div class="th">商談予約</div>
												<div class="td">
													<p><span class="hissu">＊</span>商談希望物件をお選びください。</p>
										...
										<div class="flex submit-btn fmin">
											<div class="reset-link">
												<a href="./onlline-reservation.php" onclick="" class="">リセット</a>
											</div>
								...
								<?php }else{ ?>
									<form action="./sendmail3.php" method="post" name="form2">
										<div class="table">
											<div class="rows">
												<div class="th">オンライン商談予約</div>
												<div class="td">
