<section class="tab_main js-tab-cts is-active" data-tab="tab-1">
        ...
        <div class="exterior__flex-wrapper">
            ...
            <div class="exterior__text-area exterior__text-area_02 ">
                ...
                <div class="exterior__float-area">
                    ...
                    <p class="text exterior__float-text">この地を選び、四季の自然と共生し、ともに高め合う存在であるために。外観フォルムには、そんな住まいの在り方の予感が潜んでいます。「グランファーレ幌西グランシェール」ではイタリア「ミラノ」で人気の4つ星リゾートホテルをモチーフにクラシカルな雰囲気を創出しました。格調漂う高品位レジデンス。住むことによってブランドが生まれ、そして癒される空間環境。日々育まれていくコミュニティも、心地よい生活のリズムとなることでしょう。</p>
                </div>
            </div>
        </div>
    ...
    <div class="exterior__section">
        ...
        <div class="exterior__inner exterior__inner_03">
            ...
            <p class="text exterior__text exterior__text_03">流行を追うのではなく、ディティールに至るまで本物の上質を追求し、いつの時代にも人々を魅了してきたヨーロピアンテイストのデザインの数々。その欧風美学の真髄を取り入れた「グランファーレ幌西グランシェール」は永住を考える方々へ捧げる確かな結論となるはずです。</p>
        </div>
    </div>
    <div class="exterior__section">
