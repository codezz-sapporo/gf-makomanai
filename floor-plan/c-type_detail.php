        ...
        <div class="page">
            <div class="detail">
                <div class="main">
                    ...
                    <p class="cap">リビングダイニングキッチン、全洋室がワイドバルコニーに面した2LDKプランです。玄関にはトール型の玄関収納とホールクローゼットをご用意。さらに洋室1にウォークインクローゼット、キッチンに吊戸棚を完備し収納力に配慮しました。洋室2の引き戸を解放するとリビングダイニングキッチンと一体となった約14.5帖の広々とした空間を演出することも可能です。 </p>
                    <p class="floorimg">
