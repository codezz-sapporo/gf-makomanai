...
<title>E2-type詳細 | 間取り | グランファーレ真駒内グランフォレスト | 日本グランデ株式会社</title>
...
<main class="detail-main">
            ...
            <div class="detail">
                <div class="main">
                    ...
                    <ul class="data">
                        ...
                        <li>OP：オープンペントハウス　SIC：シューズインクローゼット　W：ウォークインクローゼット　HS：ホール収納　AL：アルコーブ　TR：トランクルーム</li>
                    </ul>
                ...
                <div id="menuplan">
                    ...
                    <div class="menu">
                        ...
                        <p class="floorimg">
                            <img src="../assets/svg/a-type/d-type_menu1.svg" width="630" height="615" alt="menu1">
                        </p>
                    </div>
                    <div class="menu">
                        <dl>
                    ...
                    <div class="menu">
                        ...
                        <p class="floorimg">
                            <img src="../assets/svg/a-type/d-type_menu4.svg" width="630" height="615" alt="menu4">
                        </p>
                    </div>
                </div>
            </div>
    ...
    ?>
    <a href="<?php print URL; ?>/floor-plan/index.php?active-tab=tab-5#e2-type" class="detail-close" id="modal-close">閉じる</a>
    </div>
