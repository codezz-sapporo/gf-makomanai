<section class="tab_main js-tab-cts" data-tab="tab-2">
    <h2 class="title-h2 title-h2_entrance fadeUpTrigger">エントランス</h2>
    <div class="tab-section">
        ...
        <picture class="fadeInTrigger_slow entrance__manvisual">
            ...
            <img src="<?php print URL; ?>/assets/img/entrance/mv1.jpg" alt="グランファーレ真駒内グランフォレスト外観" class="mainvisual__img">
        </picture>
    ...
    <div class="entrance">
        ...
        <div class="tab-section tab-section_column">
            ...
            <div class="">
                ...
                <p class="text">エントランスをくぐり、ホールへと歩みを進めれば、そこはまるでヨーロッパの高級リゾートホテルのような趣です。ゆったりした空間が広がるホールの床・壁には、ローマのコロッセオを彩る大理石調トラバーチンの美しい縞模様を再現し、デザイン貼りされたTRAVERTINO GRANDEを敷き詰めてクラシカルな雰囲気を演出。静かな時間が流れるようなリラックスできるスペースになっており、美しく風格ある表情が住まう人をもおもてなしする、感性溢れる空間です。</p>
            </div>
        </div>
        <div class="tab-section tab-section_column">
            <picture class="tab-section__photo tab-section__photo_column tab-section__photo_top">
            ...
            <div class="">
                ...
                <p class="text">ナチュラルな色合いや質感に配慮しながら厳選した天然大理石やテラコッタタイル・大理石調タイルの採用。テーマとしたのは「イタリアのお城」を思い起こさせるような迎賓の空間。ここに足を踏み入れた瞬間、その静なる寛ぎに包まれるとともに、ここから始まる上質な暮らしの予想に包まれます。ゆったりとしたエントランスホールは、優雅な時間を彩るリゾートホテルライクな印象が、佇まう人を格調高く包み込みます。壁面の一部には上品な大理石調タイルとブラケット照明で豪華なデザインを施しました。天然素材の色合いと素材感が融合し、「品」と「格」を醸し出します。</p>
            </div>
        </div>
        <div class="tab-section tab-section_column">
            <picture class="tab-section__photo tab-section__photo_column tab-section__photo_top">
                <source type="image/webp" srcset="<?php print URL; ?>/assets/webp/entrance/sec4.webp">
                <img src="<?php print URL; ?>/assets/img/entrance/sec4.jpg" alt="グランファーレ真駒内グランフォレスト外観" class="">
            </picture>
            <div class="">
                <p class="title-h3 ta_c">ヨーロッパの美しい建築美を継承する<br class="br_sp">新しい心地よさ。</p>
                <p class="text">道行く人々が何気なく目を向けたとき、思わず立ち止まり見上げてしまうような洒落た佇まい。それが、私たちが目指した外観フォルムに対する美意識です。そのために、建築デザインの先進国であるヨーロッパの文化を手本に、外観の随所にエスプリとエッセンスを取り入れました。時を経ても輝きを失わないヨーロッパ建築物のように、住まう方の暮らしそのものが普遍的な美しさを保つことでしょう。</p>
            </div>
        </div>
