    ...
    <div class="entrance">
        ...
        <div class="tab-section tab-section_column">
            ...
            <div class="">
                ...
                <p class="text">エントランスをくぐり、ホールへと歩みを進めれば、そこはまるでヨーロッパの高級リゾートホテルのような趣です。ゆったりした空間が広がるホールの床には、ローマのコロッセオを彩る大理石調トラバーチンの美しい縞模様を再現し、デザイン貼りされたTRAVERTINO GRANDEを敷き詰めてクラシカルな雰囲気を演出。静かな時間が流れるようなリラックスできるスペースになっており、美しく風格ある表情が住まう人をもおもてなしする、感性溢れる空間です。</p>
            </div>
        </div>
        <div class="tab-section tab-section_column">
            <picture class="tab-section__photo tab-section__photo_column tab-section__photo_top">
            ...
            <div class="">
                ...
                <p class="text">ナチュラルな色合いや質感に配慮しながら厳選したテラコッタタイル・大理石調タイルの採用。テーマとしたのは「イタリアのお城」を思い起こさせるような迎賓の空間。ここに足を踏み入れた瞬間、その静なる寛ぎに包まれるとともに、ここから始まる上質な暮らしの予想に包まれます。ゆったりとしたエントランスホールは、優雅な時間を彩るリゾートホテルライクな印象が、佇まう人を格調高く包み込みます。壁面の一部には上品な大理石調タイルとブラケット照明で豪華なデザインを施しました。間接照明の柔らかな光と素材の質感が融合して、「品」と「格」を醸し出します。</p>
            </div>
        </div>
        <div class="tab-section tab-section_column">
            <picture class="tab-section__photo tab-section__photo_column tab-section__photo_top">
